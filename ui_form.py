...
"font-size: 20pt;")
        ...
        self.menu_load_button = QPushButton(self.menu_container_option)
        self.menu_load_button.setObjectName(u"menu_load_button")
        font1 = QFont()
        font1.setKerning(False)
        self.menu_load_button.setFont(font1)
        self.menu_load_button.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.menu_load_button.setStyleSheet(u"text-align: left; color: #333;")
        icon = QIcon()
        icon.addFile(u":/Icons/images/icons/icons8-import_gray.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.menu_load_button.setIcon(icon)
        self.menu_load_button.setIconSize(QSize(25, 25))

        self.verticalLayout_4.addWidget(self.menu_load_button)
...
"border-radius: 10px;")
    ...
    def retranslateUi(self, Main):
        ...
        self.menu_load_button.setText(QCoreApplication.translate("Main", u" Load", None))
